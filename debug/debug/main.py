...
from drone_msgs.msg import Debug
class PIDController(Node):
    def __init__(self):
        ...
        self.csv_writer.writerow(['Time', 'Proportional', 'Derivative', 'Roll', 'Roll Error', 'Roll Derivative', 'Integral'])
        self.get_logger().info("CSV logging started. Data will be saved in 'debug_data.csv'.")
    def debug_callback(self, msg: Debug):
        ...
        self.csv_writer.writerow([timestamp, prop_term, deriv_term, roll, roll_error, roll_deriv, integral])
        self.get_logger().info(
            f"Logged data: Time={timestamp}, Proportional={prop_term}, Derivative={deriv_term}, Roll = {roll}, Roll Error={roll_error}, Roll Derivative={roll_deriv}"
        )
